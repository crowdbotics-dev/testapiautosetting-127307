...
## Project Structure
    ...
    ├── testapiautosetting_127307  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127307`
...
2. Clone this repo and `cd testapiautosetting_127307`
